...
$Referer_check_domain = "shibancyu-saitama.jp";
...
$refrom_name = "人工芝の芝人　坂戸店";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせ有難う御座います";
...
<?php }else{ ?>
送信ありがとうございました。<br />
自動返信メールが届かない場合はメールアドレスの入力が間違っている可能性がありますので、再度お問い合わせください。<br /><br />
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://www.php-factory.net/" target="_blank">人工芝の芝人　坂戸店</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
